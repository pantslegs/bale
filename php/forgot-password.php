<!DOCTYPE html>
   ...
   <head>
      ...
      <link rel="stylesheet" href="../css/forgot-password/CV/assets/css/CV.css">

      <link rel="icon" href="../img/logo.png">

      <title>Balé Reset Password</title>
   </head>
   <body>
      ...
      <div class="codev">
         ...
         <form action="" class="form">
            ...
            <div class="inputs">
                <div class="box">
                   <input type="email" placeholder="Enter Code" required class="input">
